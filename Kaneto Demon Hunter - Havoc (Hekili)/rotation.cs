...
{
    public class KanetoDemonHunterHavocHekili : Rotation
    {
        ...
        public override void Initialize()
        {
            ...
            Aimsharp.PrintMessage("Kanetos PVE - Demon Hunter Havoc", Color.Yellow);
        ...
        public override bool CombatTick()
        {
            ...
            if (Aimsharp.TargetIsEnemy() && TargetAlive() && TargetInCombat)
            {
                if (Wait <= 200 && !Aimsharp.HasDebuff(Imprison_SpellName(Language), "target", true) && !Imprison && !Felblade && !FelRush)
                {
                    ...
                    if (SpellID1 == 323639 && Aimsharp.CanCast(TheHunt_SpellName(Language), "target", true, true) && !Moving)
                    {
                        if (Debug)
                        {
