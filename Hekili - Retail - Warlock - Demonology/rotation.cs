    ...
    public class EpicWarlockDemonologyHekili : Rotation
    {
        ...
        public override bool CombatTick()
        {
            ...
            if (!NoInterrupts && (Aimsharp.UnitID("target") != 168105 || Torghast_InnerFlame.Contains(Aimsharp.CastingID("target"))) && (Aimsharp.UnitID("target") != 157571 || Torghast_InnerFlame.Contains(Aimsharp.CastingID("target"))))
            {
                ...
                if (CanCastCheck(AxeToss_SpellName(Language), "target", true, true))
                {
                    if (IsInterruptable && !IsChanneling && CastingRemaining < KickValueRandom)
                    {
                        if (Debug)
            ...
            if (BilescourgeBombers && CanCastCheck(BilescourgeBombers_SpellName(Language), "player", false, true) && !Moving)
            {
            ...
            if (Aimsharp.TargetIsEnemy() && TargetAlive() && TargetInCombat && Wait <= 200)
            {
                if (!Aimsharp.HasDebuff(Banish_SpellName(Language), "target", true) && !Aimsharp.HasDebuff(Fear_SpellName(Language), "target", true) && !Banish && !Fear)
                {
                    ...
                    if (SpellID1 == 89766 && CanCastCheck(AxeToss_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 267211 && CanCastCheck(BilescourgeBombers_SpellName(Language), "player", false, true) && ((Aimsharp.CustomFunction("BilescourgeBombersMouseover") == 1 || !InstanceIDList.Contains(Aimsharp.GetMapID()) && Aimsharp.CustomFunction("BilescourgeBombersMouseoverNC") == 1) || GetCheckBox("Always Cast Bilescourge Bombers @ Cursor during Rotation") || Aimsharp.IsCustomCodeOn("BilescourgeBombersCursor")))
                    {
                        if (Debug)
                        {
                    ...
                    else if (SpellID1 == 267211 && CanCastCheck(BilescourgeBombers_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 267171 && CanCastCheck(DemonicStrength_SpellName(Language), "pet", false, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 264130 && CanCastCheck(PowerSiphon_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 111400 && CanCastCheck(BurningRush_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 264057 && CanCastCheck(SoulStrike_SpellName(Language), "pet", false, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 264119 && CanCastCheck(SummonVilefiend_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 267217 && CanCastCheck(NetherPortal_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 265187 && CanCastCheck(SummonDemonicTyrant_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 196277 && CanCastCheck(Implosion_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 104316 && CanCastCheck(CallDreadstalkers_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 264178 && CanCastCheck(Demonbolt_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 105174 && CanCastCheck(HandOfGuldan_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 603 && CanCastCheck(Doom_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 111898 && CanCastCheck(Grimoire_Felguard_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    else if (SpellID1 == 386833 && CanCastCheck(Guillotine_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
