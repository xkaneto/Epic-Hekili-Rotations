...
namespace AimsharpWow.Modules
{
    public class EpicMageFireHekili : Rotation
    {
        ...
        private static string HotStreaki_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        public override void Initialize()
        {
            ...
            Aimsharp.PrintMessage("Epic PVE - Mage Fire", Color.White);
            ...
            m_BuffsList = new List<string> { ArcaneIntellect_SpellName(Language), ShiftingPower_SpellName(Language), Combustion_SpellName(Language), HotStreaki_SpellName(Language) };
        ...
        public override bool CombatTick()
        {
            ...
            if (SpellID1 == 11366 && CanCastCheck(Pyroblast_SpellName(Language), "player", false, false) && Aimsharp.HasBuff(HotStreaki_SpellName(Language), "player") && Aimsharp.HasBuff(Combustion_SpellName(Language), "player") && Aimsharp.CastingID("player") > 0 && Aimsharp.CastingID("player") != 382440)
            {
                Aimsharp.StopCasting();
                if (Debug)
                {
                    Aimsharp.PrintMessage("Stop casting to instant cast Pyroblast - " + SpellID1, Color.Purple);
                }
                Aimsharp.Cast(Pyroblast_SpellName(Language), true);
                return true;
            }

            if (SpellID1 == 2120 && CanCastCheck(Flamestrike_SpellName(Language), "player", false, true) && Aimsharp.HasBuff(HotStreaki_SpellName(Language), "player") && Aimsharp.HasBuff(Combustion_SpellName(Language), "player") && Aimsharp.CastingID("player") > 0 && Aimsharp.CastingID("player") != 382440 && (Aimsharp.CustomFunction("FlamestrikeMouseover") == 1 || GetCheckBox("Always Cast Flamestrike @ Cursor during Rotation") || Aimsharp.IsCustomCodeOn("FlamestrikeCursor")))
            {
                Aimsharp.StopCasting();
                if (Debug)
                {
            ...
            else if (SpellID1 == 2120 && CanCastCheck(Flamestrike_SpellName(Language), "player", false, true) && Aimsharp.HasBuff(Combustion_SpellName(Language), "player") && Aimsharp.HasBuff(HotStreaki_SpellName(Language), "player") && Aimsharp.CastingID("player") > 0 && Aimsharp.CastingID("player") != 382440)
            {
                Aimsharp.StopCasting();
                if (Debug)
                {
            ...
            if (SpellID1 == 108853 && CanCastCheck(FireBlast_SpellName(Language), "target", true, false) && Aimsharp.CustomFunction("HekiliWait") <= 200 && Aimsharp.CastingID("player") != 382440)
            {
                if (Debug)
                {
            ...
            if (SpellID1 == 190319 && CanCastCheck(Combustion_SpellName(Language), "player", false, false) && Aimsharp.CustomFunction("HekiliWait") <= 200 && Aimsharp.CastingID("player") != 382440)
            {
                if (Debug)
                {
            ...
            if (SpellID1 == 11366 && CanCastCheck(Pyroblast_SpellName(Language), "player", false, false) && Aimsharp.CustomFunction("HekiliWait") > 0 && Aimsharp.CastingID("player") != 382440)
            {
                if (Debug)
                {
            ...
            if (SpellID1 == 2120 && CanCastCheck(Flamestrike_SpellName(Language), "player", false, true) && Aimsharp.CustomFunction("HekiliWait") > 0 && Aimsharp.CastingID("player") != 382440 && (Aimsharp.CustomFunction("FlamestrikeMouseover") == 1 || GetCheckBox("Always Cast Flamestrike @ Cursor during Rotation") || Aimsharp.IsCustomCodeOn("FlamestrikeCursor")))
            {
                if (Debug)
                {
            ...
            else if (SpellID1 == 2120 && CanCastCheck(Flamestrike_SpellName(Language), "player", false, true) && Aimsharp.CustomFunction("HekiliWait") > 0 && Aimsharp.CastingID("player") != 382440)
            {
                if (Debug)
                {
            ...
            if (!NoSpellsteal && CanCastCheck(Spellsteal_SpellName(Language), "mouseover", true, true) && (!GetCheckBox("Don't Spellsteal during Combustion:") || GetCheckBox("Don't Spellsteal during Combustion:") && !Aimsharp.HasBuff(Combustion_SpellName(Language), "player", true)))
            {
            ...
            if (!NoSpellsteal && CanCastCheck(Spellsteal_SpellName(Language), "target", true, true) && (!GetCheckBox("Don't Spellsteal during Combustion:") || GetCheckBox("Don't Spellsteal during Combustion:") && !Aimsharp.HasBuff(Combustion_SpellName(Language), "player", true)))
            {
            ...
            if (Meteor && CanCastCheck(Meteor_SpellName(Language), "player", false, true) && !Moving)
            {
                switch (MeteorCast)
                {
                    case "Manual":
            ...
            if (Flamestrike && CanCastCheck(Flamestrike_SpellName(Language), "player", false, true) && !Moving)
            {
            ...
            if (Aimsharp.TargetIsEnemy() && TargetAlive() && TargetInCombat && Wait <= 200)
            {
                if (!Aimsharp.HasDebuff(Polymorph_SpellName(Language), "target", true) && !Polymorph && !ArcaneExplosion)
                {
                    ...
                    if (!NoSpellsteal && SpellID1 == 30449 && CanCastCheck(Spellsteal_SpellName(Language), "target", true, true) && (!GetCheckBox("Don't Spellsteal during Combustion:") || GetCheckBox("Don't Spellsteal during Combustion:") && !Aimsharp.HasBuff(Combustion_SpellName(Language), "player", true)))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 235313 && CanCastCheck(BlazingBarrier_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 190319 && CanCastCheck(Combustion_SpellName(Language), "player", false, false))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Combustion - " + SpellID1, Color.Purple);
                    ...
                    if (SpellID1 == 2120 && CanCastCheck(Flamestrike_SpellName(Language), "player", false, true) && (Aimsharp.CustomFunction("FlamestrikeMouseover") == 1 || GetCheckBox("Always Cast Flamestrike @ Cursor during Rotation") || Aimsharp.IsCustomCodeOn("FlamestrikeCursor")))
                    {
                        if (Debug)
                        {
                    ...
                    else if (SpellID1 == 2120 && CanCastCheck(Flamestrike_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 44457 && CanCastCheck(LivingBomb_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 108853 && CanCastCheck(FireBlast_SpellName(Language), "target", true, false))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Fire Blast - " + SpellID1, Color.Purple);
                    ...
                    if (SpellID1 == 257541 && CanCastCheck(PhoenixFlames_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 11366 && CanCastCheck(Pyroblast_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 2948 && CanCastCheck(Scorch_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 133 && CanCastCheck(Fireball_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
