...
{
    public class KanetoMageArcaneHekili : Rotation
    {
        //Random Number
        ...
        private static string ArcaneBarrage_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string ArcaneBlast_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string ArcaneFamiliar_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string ArcaneMissiles_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string ArcaneOrb_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string ArcaneSurge_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string ConjureManaGem_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string ConjureRefreshment_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string NetherTempest_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string PresenceOfMind_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string PrismaticBarrier_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string Slow_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string Supernova_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string TouchOfTheMagi_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        public override void LoadSettings()
        {
            ...
            Settings.Add(new Setting("Race:", m_RaceList, ""));
            Settings.Add(new Setting("Ingame World Latency:", 1, 500, 50));
            Settings.Add(new Setting(" "));
        ...
        public override void Initialize()
        {
            ...
            Aimsharp.PrintMessage("/" + FiveLetters + " Evocation - Casts Evocation @ next GCD", Color.Yellow);
            ...
            m_BuffsList = new List<string> { ArcaneIntellect_SpellName(Language), ArcaneSurge_SpellName(Language), Evocation_SpellName(Language), ShiftingPower_SpellName(Language), PresenceOfMind_SpellName(Language), };
            ...
            m_ItemsList = new List<string> { Healthstone_SpellName(Language), ManaGem_SpellName(Language), };
            m_SpellBook = new List<string> {
                //Covenants
                RadiantSpark_SpellName(Language), //307443
                Deathborne_SpellName(Language), //324220
                ShiftingPower_SpellName(Language), //314791
                MirrorsOfTorment_SpellName(Language), //314793

                //Covenant Signature Abilites
                ...
                //General Mage
                ArcaneBarrage_SpellName(Language), //44425
                ArcaneBlast_SpellName(Language), //30451
                ArcaneExplosion_SpellName(Language), //1449
                ArcaneFamiliar_SpellName(Language), //205022
                ArcaneIntellect_SpellName(Language), //1459
                ArcaneMissiles_SpellName(Language), //5143
                ArcaneOrb_SpellName(Language), //153626
                ArcaneSurge_SpellName(Language), //365350
                AlterTime_SpellName(Language), //342245
                Blink_SpellName(Language), //1953 or 212653
                BlastWave_SpellName(Language), //157981
                ConjureManaGem_SpellName(Language), //759
                ConjureRefreshment_SpellName(Language), //190336
                ConeOfCold_SpellName(Language), //120
                Displacement_SpellName(Language), //389713
                DragonsBreath_SpellName(Language),//31661
                Evocation_SpellName(Language), //12051
                FireBlast_SpellName(Language), //319836
                ...
                IceNova_SpellName(Language), //257997
        ...
        public override bool CombatTick()
        {
            ...
            if (Aimsharp.CastingID("player") == 118 && Aimsharp.CastingRemaining("player") > 0 && Aimsharp.CastingRemaining("player") <= 400 && Aimsharp.IsCustomCodeOn("Polymorph"))
            {
                if (Debug)
                {
                    Aimsharp.PrintMessage("Turning Off Polymorph Queue", Color.Black);
                }
            ...
            if (!NoInterrupts && (Aimsharp.UnitID("target") != 168105 || Torghast_InnerFlame.Contains(Aimsharp.CastingID("target"))) && (Aimsharp.UnitID("target") != 157571 || Torghast_InnerFlame.Contains(Aimsharp.CastingID("target"))))
            {
                ...
                if (Aimsharp.CanCast(Counterspell_SpellName(Language), "target", true, true))
                {
                    if (IsInterruptable && !IsChanneling && CastingRemaining < KickValueRandom)
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Target Casting ID: " + Aimsharp.CastingID("target") + ", Interrupting", Color.Black);
                        }
                ...
                if (Aimsharp.CanCast(Counterspell_SpellName(Language), "target", true, true))
                {
                    if (IsInterruptable && IsChanneling && CastingElapsed > KickChannelsAfterRandom)
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Target Channeling ID: " + Aimsharp.CastingID("target") + ", Interrupting", Color.Black);
                        }
                        Aimsharp.Cast(Counterspell_SpellName(Language), true);
                        return true;
                    }
            ...
            if (Aimsharp.CanUseItem(Healthstone_SpellName(Language), false) && Aimsharp.ItemCooldown(Healthstone_SpellName(Language)) == 0)
            {
                if (Aimsharp.Health("player") <= GetSlider("Auto Healthstone @ HP%"))
                {
                    if (Debug)
                    {
                        Aimsharp.PrintMessage("Using Healthstone - Player HP% " + Aimsharp.Health("player") + " due to setting being on HP% " + GetSlider("Auto Healthstone @ HP%"), Color.Black);
                    }
            ...
            if (Aimsharp.CanCast(IceBlock_SpellName(Language), "player", false, true))
            {
                if (PlayerHP <= GetSlider("Auto Ice Block @ HP%"))
                {
                    ...
                    if (Debug)
                    {
                        Aimsharp.PrintMessage("Casting Ice Block - Player HP% " + PlayerHP + " due to setting being on HP% " + GetSlider("Auto Ice Block @ HP%"), Color.Black);
                    }
                    return true;
                }
            }
            ...
            if (Aimsharp.CanCast(AlterTime_SpellName(Language), "player", false, true))
            {
                if (PlayerHP <= GetSlider("Auto Alter Time @ HP%"))
                {
                    ...
                    if (Debug)
                    {
                        Aimsharp.PrintMessage("Casting Alter Time - Player HP% " + PlayerHP + " due to setting being on HP% " + GetSlider("Auto Alter Time @ HP%"), Color.Black);
                    }
                    return true;
                }
            }
            ...
            if (Aimsharp.CanCast(PrismaticBarrier_SpellName(Language), "player", false, true))
            {
                ...
                {
                    Aimsharp.Cast(PrismaticBarrier_SpellName(Language));
                    if (Debug)
                    {
                        Aimsharp.PrintMessage("Casting Prismatic Barrier - Player HP% " + PlayerHP + " due to setting being on HP% " + GetSlider("Auto Prismatic Barrier @ HP%"), Color.Black);
                    }
                    return true;
                }
            }
            ...
            if (!NoSpellsteal && Aimsharp.CanCast(Spellsteal_SpellName(Language), "mouseover", true, true) && (!GetCheckBox("Don't Spellsteal during Arcane Surge:") || GetCheckBox("Don't Spellsteal during Arcane Surge:") && !Aimsharp.HasBuff(ArcaneSurge_SpellName(Language), "player", true)))
            {
                if (GetCheckBox("Auto Spellsteal Mouseover:") && Aimsharp.CustomFunction("SpellstealCheckMouseover") == 3)
                {
                    ...
                    if (Debug)
                    {
                        Aimsharp.PrintMessage("Casting Spellsteal on Mouseover", Color.Black);
                    }
                    return true;
                }
            }
            ...
            if (!NoSpellsteal && Aimsharp.CanCast(Spellsteal_SpellName(Language), "target", true, true) && (!GetCheckBox("Don't Spellsteal during Arcane Surge:") || GetCheckBox("Don't Spellsteal during Arcane Surge:") && !Aimsharp.HasBuff(ArcaneSurge_SpellName(Language), "player", true)))
            {
                if (GetCheckBox("Auto Spellsteal Target:") && Aimsharp.CustomFunction("SpellstealCheckTarget") == 3)
                {
                    ...
                    if (Debug)
                    {
                        Aimsharp.PrintMessage("Casting Spellsteal on Target", Color.Black);
                    }
                    return true;
                }
            }
            ...
            if (Polymorph && Aimsharp.CanCast(Polymorph_SpellName(Language), "mouseover", true, true) && !Moving)
            {
                if (Debug)
                {
                    Aimsharp.PrintMessage("Casting Polymorph - Queue", Color.Black);
                }
            ...
            if (Aimsharp.SpellCooldown(Evocation_SpellName(Language)) - Aimsharp.GCD() > 2000 && Evocation)
            {
                if (Debug)
                {
                    Aimsharp.PrintMessage("Turning Off Evocation Queue", Color.Black);
                }
            ...
            if (Evocation && Aimsharp.CanCast(Evocation_SpellName(Language), "player", false, true) && !Moving)
            {
                if (Debug)
                {
                    Aimsharp.PrintMessage("Casting Evocation - Queue", Color.Black);
                }
                Aimsharp.Cast(Evocation_SpellName(Language));
                return true;
            }
            ...
            if (ArcaneExplosion && Aimsharp.CanCast(ArcaneExplosion_SpellName(Language), "player", false, true))
            {
                if (Debug)
                {
                    Aimsharp.PrintMessage("Casting Arcane Explosion - Queue", Color.Black);
                }
            ...
            if ((Aimsharp.SpellCooldown(DoorOfShadows_SpellName(Language)) - Aimsharp.GCD() > 2000 || Moving) && DoorofShadows)
            {
                if (Debug)
                {
                    Aimsharp.PrintMessage("Turning Off Door of Shadows Queue", Color.Black);
                }
            ...
            if (DoorofShadows && Aimsharp.CanCast(DoorOfShadows_SpellName(Language), "player", false, true))
            {
                if (Debug)
                {
                    Aimsharp.PrintMessage("Casting Door of Shadows - Queue", Color.Black);
                }
            ...
            if ((Aimsharp.SpellCooldown(RingOfFrost_SpellName(Language)) - Aimsharp.GCD() > 2000 || Moving) && RingofFrost)
            {
                if (Debug)
                {
                    Aimsharp.PrintMessage("Turning Off Ring of Frost Queue", Color.Black);
                }
            ...
            if (RingofFrost && Aimsharp.CanCast(RingOfFrost_SpellName(Language), "player", false, true) && !Moving)
            {
                switch (RingofFrostCast)
                {
                    case "Manual":
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Ring of Frost - " + RingofFrostCast + " - Queue", Color.Black);
                        }
                    ...
                    if (Aimsharp.CanCast(RemoveCurse_SpellName(Language), unit.Key, false, true) && (unit.Key == "player" || Aimsharp.Range(unit.Key) <= 40) && isUnitCleansable(target, states))
                    {
                        ...
                        else
                        {
                            if (UnitFocus(unit.Key))
                            {
                                ...
                                if (Debug)
                                {
                                    Aimsharp.PrintMessage("Remove Curse @ " + unit.Key + " - " + unit.Value, Color.Black);
                                }
                                return true;
                            }
                        }
            ...
            if (Aimsharp.TargetIsEnemy() && TargetAlive() && TargetInCombat && Wait <= 200)
            {
                if (Aimsharp.Range("target") <= 40 && !Aimsharp.HasDebuff(Polymorph_SpellName(Language), "target", true) && !Polymorph && !ArcaneExplosion)
                {
                    ...
                    if (CooldownsToggle == 1 && UseTrinketsCD && Aimsharp.CanUseTrinket(0))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Using Top Trinket on Cooldown", Color.Black);
                        }
                    ...
                    if (CooldownsToggle == 2 && UseTrinketsCD && Aimsharp.CanUseTrinket(1))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Using Bot Trinket on Cooldown", Color.Black);
                        }
                    ...
                    if (SpellID1 == 1 && Aimsharp.CanUseTrinket(0))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Using Top Trinket", Color.Black);
                        }
                        Aimsharp.Cast("TopTrinket");
                        return true;
                    }
                    ...
                    if (SpellID1 == 28880 && Aimsharp.CanCast(GiftOfTheNaaru_SpellName(Language), "player", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Gift of the Naaru - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 20594 && Aimsharp.CanCast(Stoneform_SpellName(Language), "player", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Stoneform - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 20589 && Aimsharp.CanCast(EscapeArtist_SpellName(Language), "player", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Escape Artist - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 59752 && Aimsharp.CanCast(WillToSurvive_SpellName(Language), "player", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Will to Survive - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 255647 && Aimsharp.CanCast(LightsJudgment_SpellName(Language), "player", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Light's Judgment - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 265221 && Aimsharp.CanCast(Fireblood_SpellName(Language), "player", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Fireblood - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 69041 && Aimsharp.CanCast(RocketBarrage_SpellName(Language), "player", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Rocket Barrage - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 20549 && Aimsharp.CanCast(WarStomp_SpellName(Language), "player", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting War Stomp - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 7744 && Aimsharp.CanCast(WillOfTheForsaken_SpellName(Language), "player", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Will of the Forsaken - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 260364 && Aimsharp.CanCast(ArcanePulse_SpellName(Language), "player", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Arcane Pulse - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 255654 && Aimsharp.CanCast(BullRush_SpellName(Language), "player", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Bull Rush - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 312411 && Aimsharp.CanCast(BagOfTricks_SpellName(Language), "player", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Bag of Tricks - " + SpellID1, Color.Black);
                        }
                    ...
                    if ((SpellID1 == 20572 || SpellID1 == 33702 || SpellID1 == 33697) && Aimsharp.CanCast(BloodFury_SpellName(Language), "player", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Blood Fury - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 26297 && Aimsharp.CanCast(Berserking_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Berserking - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 274738 && Aimsharp.CanCast(AncestralCall_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Ancestral Call - " + SpellID1, Color.Black);
                        }
                    ...
                    if ((SpellID1 == 28730 || SpellID1 == 25046 || SpellID1 == 50613 || SpellID1 == 69179 || SpellID1 == 80483 || SpellID1 == 129597) && Aimsharp.CanCast(ArcaneTorrent_SpellName(Language), "player", true, false))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Arcane Torrent - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 58984 && Aimsharp.CanCast(Shadowmeld_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Shadowmeld - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 307443 && Aimsharp.CanCast(RadiantSpark_SpellName(Language), "target", true, true) && !Moving)
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Radiant Spark - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 324220 && Aimsharp.CanCast(Deathborne_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Deathborne - " + SpellID1, Color.Black);
                        }
                    ...
                    if ((SpellID1 == 314791 || SpellID1 == 382440) && Aimsharp.CanCast(ShiftingPower_SpellName(Language), "player", false, true) && !Moving)
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Shifting Power - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 314793 && Aimsharp.CanCast(MirrorsOfTorment_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Mirrors of Torment - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 324631 && Aimsharp.CanCast(Fleshcraft_SpellName(Language), "player", false, true) && !Moving)
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Fleshcraft - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 2139 && Aimsharp.CanCast(Counterspell_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Counterspell- " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(Counterspell_SpellName(Language), true);
                        return true;
                    }
                    ...
                    if (SpellID1 == 44425 && Aimsharp.CanCast(ArcaneBarrage_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Arcane Barrage - " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(ArcaneBarrage_SpellName(Language));
                        return true;
                    }
                    ...
                    if (SpellID1 == 30451 && Aimsharp.CanCast(ArcaneBlast_SpellName(Language), "target", true, true) && (!Moving || Aimsharp.HasBuff(PresenceOfMind_SpellName(Language), "player", true)))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Arcane Blast - " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(ArcaneBlast_SpellName(Language));
                        return true;
                    }
                    ...
                    if (SpellID1 == 5143 && Aimsharp.CanCast(ArcaneMissiles_SpellName(Language), "target", true, true) && !Moving)
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Arcane Missiles - " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(ArcaneMissiles_SpellName(Language));
                        return true;
                    }
                    ...
                    if (SpellID1 == 319836 && Aimsharp.CanCast(FireBlast_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Fire Blast - " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(FireBlast_SpellName(Language));
                        return true;
                    }
                    ...
                    if (SpellID1 == 116 && Aimsharp.CanCast(Frostbolt_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Frostbolt - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 114923 && Aimsharp.CanCast(NetherTempest_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Nether Tempest - " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(NetherTempest_SpellName(Language));
                        return true;
                    }
                    ...
                    if (SpellID1 == 118 && Aimsharp.CanCast(Polymorph_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Polymorph - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 31589 && Aimsharp.CanCast(Slow_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Slow - " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(Slow_SpellName(Language));
                        return true;
                    }
                    ...
                    if (!NoSpellsteal && SpellID1 == 30449 && Aimsharp.CanCast(Spellsteal_SpellName(Language), "target", true, true) && (!GetCheckBox("Don't Spellsteal during Arcane Surge:") || GetCheckBox("Don't Spellsteal during Arcane Surge:") && !Aimsharp.HasBuff(ArcaneSurge_SpellName(Language), "player", true)))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Spellsteal - " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(Spellsteal_SpellName(Language));
                        return true;
                    }
                    ...
                    if (SpellID1 == 157980 && Aimsharp.CanCast(Supernova_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Supernova - " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(Supernova_SpellName(Language));
                        return true;
                    }
                    ...
                    if (SpellID1 == 321507 && Aimsharp.CanCast(TouchOfTheMagi_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Touch of the Magi - " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(TouchOfTheMagi_SpellName(Language));
                        return true;
                    }
                    #endregion
                    ...
                    if (SpellID1 == 999999 && Aimsharp.CanUseItem(ManaGem_SpellName(Language), false))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Using Mana Gem - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 1449 && Aimsharp.CanCast(ArcaneExplosion_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Arcane Explosion - " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(ArcaneExplosion_SpellName(Language));
                        return true;
                    }
                    ...
                    if (SpellID1 == 205022 && Aimsharp.CanCast(ArcaneFamiliar_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Arcane Familiar - " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(ArcaneFamiliar_SpellName(Language));
                        return true;
                    }
                    ...
                    if (SpellID1 == 1459 && Aimsharp.CanCast(ArcaneIntellect_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Arcane Intellect - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 153626 && Aimsharp.CanCast(ArcaneOrb_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Arcane Orb - " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(ArcaneOrb_SpellName(Language));
                        return true;
                    }
                    ...
                    if (SpellID1 == 365350 && Aimsharp.CanCast(ArcaneSurge_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Arcane Surge - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 342245 && Aimsharp.CanCast(AlterTime_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Alter Time - " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(AlterTime_SpellName(Language));
                        return true;
                    }
                    if (SpellID1 == 157981 && Aimsharp.CanCast(BlastWave_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Blast Wave - " + SpellID1, Color.Black);
                        }
                    ...
                    if ((SpellID1 == 1953 || SpellID1 == 212653) && Aimsharp.CanCast(Blink_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Blink - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 759 && Aimsharp.CanCast(ConjureManaGem_SpellName(Language), "player", false, true) && !Moving)
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Conjure Mana Gem - " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(ConjureManaGem_SpellName(Language));
                        return true;
                    }
                    ...
                    if (SpellID1 == 190336 && Aimsharp.CanCast(ConjureRefreshment_SpellName(Language), "player", false, true) && !Moving)
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Conjure Refreshment - " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(ConjureRefreshment_SpellName(Language));
                        return true;
                    }
                    ...
                    if (SpellID1 == 31661 && Aimsharp.CanCast(DragonsBreath_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Dragon's Breath - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 12051 && Aimsharp.CanCast(Evocation_SpellName(Language), "player", false, true) && !Moving)
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Evocation - " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(Evocation_SpellName(Language));
                        return true;
                    }
                    ...
                    if (SpellID1 == 122 && Aimsharp.CanCast(FrostNova_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Frost Nova - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 110959 && Aimsharp.CanCast(GreaterInvisibility_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Greater Invisibility - " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(GreaterInvisibility_SpellName(Language));
                        return true;
                    }
                    ...
                    if (SpellID1 == 45438 && Aimsharp.CanCast(IceBlock_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Ice Block - " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(IceBlock_SpellName(Language));
                        return true;
                    }
                    ...
                    if (SpellID1 == 55342 && Aimsharp.CanCast(MirrorImage_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Mirror Image - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 205025 && Aimsharp.CanCast(PresenceOfMind_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Presence of Mind - " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(PresenceOfMind_SpellName(Language));
                        return true;
                    }
                    ...
                    if (SpellID1 == 235450 && Aimsharp.CanCast(PrismaticBarrier_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Prismatic Barrier - " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(PrismaticBarrier_SpellName(Language));
                        return true;
                    }
                    ...
                    if (SpellID1 == 475 && Aimsharp.CanCast(RemoveCurse_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Remove Curse - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 113724 && Aimsharp.CanCast(RingOfFrost_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Ring of Frost - " + SpellID1, Color.Black);
                        }
                        Aimsharp.Cast(RingOfFrost_SpellName(Language));
                        return true;
                    }
                    ...
                    if (SpellID1 == 116011 && Aimsharp.CanCast(RuneOfPower_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Rune of Power - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 130 && Aimsharp.CanCast(SlowFall_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Slow Fall - " + SpellID1, Color.Black);
                        }
                    ...
                    if (SpellID1 == 80353 && Aimsharp.CanCast(TimeWarp_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Time Warp - " + SpellID1, Color.Black);
                        }
        ...
        public override bool OutOfCombatTick()
        {
            ...
            if (SpellID1 == 1459 && Aimsharp.CanCast(ArcaneIntellect_SpellName(Language), "player", false, true) && AIOOC)
            {
                if (Debug)
                {
                    Aimsharp.PrintMessage("Casting Arcane Intellect (Out of Combat) - " + SpellID1, Color.Black);
                }
                Aimsharp.Cast(ArcaneIntellect_SpellName(Language));
                return true;
            }
            ...
            if (PhialCount <= 0 && Aimsharp.CanCast(SummonSteward_SpellName(Language), "player") && Aimsharp.GetMapID() != 2286 && Aimsharp.GetMapID() != 1666 && Aimsharp.GetMapID() != 1667 && Aimsharp.GetMapID() != 1668 && Aimsharp.CastingID("player") == 0)
            {
                if (Debug)
                {
                    Aimsharp.PrintMessage("Casting Summon Steward due to Phial Count being: " + PhialCount, Color.Black);
                }
            ...
            if (GetCheckBox("Auto Start Combat:") == true && Aimsharp.TargetIsEnemy() && TargetAlive() && Aimsharp.Range("target") <= 40 && TargetInCombat && !Aimsharp.HasDebuff(Polymorph_SpellName(Language), "target", true) && !Polymorph)
            {
                if (Debug)
                {
                    Aimsharp.PrintMessage("Starting Combat from Out of Combat", Color.Black);
                }
                return CombatTick();
            }
            #endregion
