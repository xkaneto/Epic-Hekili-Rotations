...
namespace AimsharpWow.Modules
{
    public class EpicMageArcaneHekili : Rotation
    {
        ...
        #region Lists
        //Lists
        private List<string> m_IngameCommandsList = new List<string> { "NoInterrupts", "NoDecurse", "NoCycle", "Polymorph", "Evocation", "RingofFrost", "ArcaneExplosion", "NoSpellsteal", };
