...
namespace AimsharpWow.Modules
{
    public class EpicRogueAssassinationHekili : Rotation
    {
        ...
        {
            if (Aimsharp.CanCast(Sepsis_SpellName(Language), unit, true, true) || (Aimsharp.SpellCooldown(Sepsis_SpellName(Language)) - Aimsharp.GCD() <= 0 && (Aimsharp.GCD() > 0 && Aimsharp.GCD() < Aimsharp.CustomFunction("GetSpellQueueWindow") || Aimsharp.GCD() == 0) && Aimsharp.Power("player") >= 25&& TargetAlive() && !TorghastList.Contains(Aimsharp.GetMapID())))
                return true;
        ...
        {
            if (Aimsharp.CanCast(SerratedBoneSpike_SpellName(Language), unit, true, true) || ((Aimsharp.SpellCooldown(SerratedBoneSpike_SpellName(Language)) - Aimsharp.GCD() <= 0 && (Aimsharp.GCD() > 0 && Aimsharp.GCD() < Aimsharp.CustomFunction("GetSpellQueueWindow") || Aimsharp.GCD() == 0) || Aimsharp.SpellCharges(SerratedBoneSpike_SpellName(Language)) >= 1 && (Aimsharp.GCD() > 0 && Aimsharp.GCD() < Aimsharp.CustomFunction("GetSpellQueueWindow") || Aimsharp.GCD() == 0)) && Aimsharp.Power("player") >= 15 && TargetAlive() && !TorghastList.Contains(Aimsharp.GetMapID())))
                return true;
        ...
        {
            if (Aimsharp.CanCast(EchoingReprimand_SpellName(Language), unit, true, true) || (Aimsharp.SpellCooldown(EchoingReprimand_SpellName(Language)) - Aimsharp.GCD() <= 0 && (Aimsharp.GCD() > 0 && Aimsharp.GCD() < Aimsharp.CustomFunction("GetSpellQueueWindow") || Aimsharp.GCD() == 0) && Aimsharp.Power("player") >= 10 && TargetAlive() && !TorghastList.Contains(Aimsharp.GetMapID())))
                return true;
        ...
        {
            if (Aimsharp.CanCast(Flagellation_SpellName(Language), unit, true, true) || (Aimsharp.SpellCooldown(Flagellation_SpellName(Language)) - Aimsharp.GCD() <= 0 && (Aimsharp.GCD() > 0 && Aimsharp.GCD() < Aimsharp.CustomFunction("GetSpellQueueWindow") || Aimsharp.GCD() == 0) && TargetAlive() && !TorghastList.Contains(Aimsharp.GetMapID())))
                return true;
        ...
        {
            if (Aimsharp.CanCast(KidneyShot_SpellName(Language), unit, true, true) || (Aimsharp.SpellCooldown(KidneyShot_SpellName(Language)) - Aimsharp.GCD() <= 0 && (Aimsharp.GCD() > 0 && Aimsharp.GCD() < Aimsharp.CustomFunction("GetSpellQueueWindow") || Aimsharp.GCD() == 0) && Aimsharp.Power("player") >= 25 && Aimsharp.PlayerSecondaryPower() >= 1  && TargetAlive() && !TorghastList.Contains(Aimsharp.GetMapID())))
                return true;
        ...
        {
            if (Aimsharp.CanCast(Shiv_SpellName(Language), unit, true, true) || (Aimsharp.SpellCooldown(Shiv_SpellName(Language)) - Aimsharp.GCD() <= 0 && (Aimsharp.GCD() > 0 && Aimsharp.GCD() < Aimsharp.CustomFunction("GetSpellQueueWindow") || Aimsharp.GCD() == 0) && Aimsharp.Power("player") >= 20  && TargetAlive() && !TorghastList.Contains(Aimsharp.GetMapID())))
                return true;
        ...
        {
            if (Aimsharp.CanCast(Blind_SpellName(Language), unit, true, true) || (Aimsharp.SpellCooldown(Blind_SpellName(Language)) - Aimsharp.GCD() <= 0 && (Aimsharp.GCD() > 0 && Aimsharp.GCD() < Aimsharp.CustomFunction("GetSpellQueueWindow") || Aimsharp.GCD() == 0) && TargetAlive() && !TorghastList.Contains(Aimsharp.GetMapID())))
                return true;
        ...
        {
            if (Aimsharp.CanCast(MarkedForDeath_SpellName(Language), unit, true, true) || (Aimsharp.SpellCooldown(MarkedForDeath_SpellName(Language)) <= 0 && Aimsharp.CustomFunction("GetSpellMarkedForDeath") == 1 && TargetAlive() && !TorghastList.Contains(Aimsharp.GetMapID())))
                return true;
        ...
        {
            if (Aimsharp.CanCast(Mutilate_SpellName(Language), unit, true, true) || (Aimsharp.SpellCooldown(Mutilate_SpellName(Language)) - Aimsharp.GCD() <= 0 && (Aimsharp.GCD() > 0 && Aimsharp.GCD() < Aimsharp.CustomFunction("GetSpellQueueWindow") || Aimsharp.GCD() == 0) && Aimsharp.Power("player") >= 50  && TargetAlive() && !TorghastList.Contains(Aimsharp.GetMapID())))
                return true;
        ...
        {
            if (Aimsharp.CanCast(Garrote_SpellName(Language), unit, true, true) || (Aimsharp.SpellCooldown(Garrote_SpellName(Language)) - Aimsharp.GCD() <= 0 && (Aimsharp.GCD() > 0 && Aimsharp.GCD() < Aimsharp.CustomFunction("GetSpellQueueWindow") || Aimsharp.GCD() == 0) && Aimsharp.Power("player") >= 45  && TargetAlive() && !TorghastList.Contains(Aimsharp.GetMapID())))
                return true;
        ...
        {
            if (Aimsharp.CanCast(Rupture_SpellName(Language), unit, true, true) || (Aimsharp.SpellCooldown(Rupture_SpellName(Language)) - Aimsharp.GCD() <= 0 && (Aimsharp.GCD() > 0 && Aimsharp.GCD() < Aimsharp.CustomFunction("GetSpellQueueWindow") || Aimsharp.GCD() == 0) && Aimsharp.Power("player") >= 25 && Aimsharp.PlayerSecondaryPower() >= 1  && TargetAlive() && !TorghastList.Contains(Aimsharp.GetMapID())))
                return true;
        ...
        {
            if (Aimsharp.CanCast(PoisonedKnife_SpellName(Language), unit, true, true) || (Aimsharp.SpellCooldown(PoisonedKnife_SpellName(Language)) - Aimsharp.GCD() <= 0 && (Aimsharp.GCD() > 0 && Aimsharp.GCD() < Aimsharp.CustomFunction("GetSpellQueueWindow") || Aimsharp.GCD() == 0) && Aimsharp.Power("player") >= 40 && TargetAlive() && !TorghastList.Contains(Aimsharp.GetMapID())))
                return true;
        ...
        {
            if (Aimsharp.CanCast(Exsanguinate_SpellName(Language), unit, true, true) || (Aimsharp.SpellCooldown(Exsanguinate_SpellName(Language)) - Aimsharp.GCD() <= 0 && (Aimsharp.GCD() > 0 && Aimsharp.GCD() < Aimsharp.CustomFunction("GetSpellQueueWindow") || Aimsharp.GCD() == 0) && Aimsharp.Power("player") >= 25  && TargetAlive() && !TorghastList.Contains(Aimsharp.GetMapID())))
                return true;
        ...
        {
            if (Aimsharp.CanCast(Shadowstep_SpellName(Language), unit, false, true) || (Aimsharp.SpellCooldown(Shadowstep_SpellName(Language)) <= 0 && TargetAlive() && !TorghastList.Contains(Aimsharp.GetMapID())))
                return true;
        ...
        public override void Initialize()
        {
            ...
            Aimsharp.PrintMessage("Epic PVE - Rogue Assassination", Color.White);
        ...
        public override bool CombatTick()
        {
            ...
            if (Aimsharp.TargetIsEnemy() && TargetAlive() && TargetInCombat)
            {
                ...
                if (UnitDebuffSap("target") == 0 && UnitDebuffBlind("target") == 0 && !KidneyShot && Wait <= 200)
                {
                    ...
                    if (SpellID1 == 185313 && CanCastCheck(ShadowDance_SpellName(Language),"player"))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 381802 && CanCastCheck(IndiscriminateCarnage_SpellName(Language), "player"))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 385627 && CanCastCheck(Kingsbane_SpellName(Language), "target"))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 360194 && CanCastCheck(Deathmark_SpellName(Language), "target"))
                    {
                        if (Debug)
                        {
