...
{
    public class EpicMageFrostHekili : Rotation
    {
        //Random Number
        ...
        private static string Blizzard_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string ColdSnap_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string CometStorm_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string Ebonbolt_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string FrozenOrb_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string GlacialSpike_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string IceBarrier_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string IceLance_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string IcyVeins_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string RayOfFrost_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        private static string SummonWaterElemental_SpellName(string Language = "English")
        {
            switch (Language)
            {
        ...
        #region Lists
        //Lists
        private List<string> m_IngameCommandsList = new List<string> { "NoInterrupts", "NoDecurse", "NoCycle", "Polymorph", "RingofFrost", "Blizzard", "ArcaneExplosion", "FrozenOrb", "BlizzardCursor", "FrozenOrbCursor", "NoSpellsteal", };
        ...
        private void InitializeMacros()
        {
            ...
            Macros.Add("FrozenOrbOff", "/" + FiveLetters + " FrozenOrb");
        ...
        public override void Initialize()
        {
            ...
            Aimsharp.PrintMessage("Epic PVE - Mage Frost", Color.White);
            ...
            Aimsharp.PrintMessage("Wowhead: https://www.wowhead.com/guide/classes/mage/frost/overview-pve-dps", Color.Yellow);
            Aimsharp.PrintMessage("-----", Color.Black);
            ...
            Aimsharp.PrintMessage("/" + FiveLetters + " Blizzard - Casts Blizzard @ next GCD", Color.Yellow);
            Aimsharp.PrintMessage("/" + FiveLetters + " FrozenOrb - Casts Frozen Orb @ next GCD", Color.Yellow);
            Aimsharp.PrintMessage("/" + FiveLetters + " BlizzardCursor - Toggles Blizzard always @ Cursor (same as Option)", Color.Yellow);
            Aimsharp.PrintMessage("/" + FiveLetters + " FrozenOrbCursor - Toggles Frozen Orb always @ Cursor (same as Option)", Color.Yellow);
            Aimsharp.PrintMessage("-----", Color.Black);
            ...
            m_BuffsList = new List<string> { ArcaneIntellect_SpellName(Language), ShiftingPower_SpellName(Language), IcyVeins_SpellName(Language), };
            ...
            m_SpellBook = new List<string> {
                ...
                IceBarrier_SpellName(Language), //11426
                ...
                //Frost Mage
                Blizzard_SpellName(Language), //190356
                ColdSnap_SpellName(Language), //235219
                CometStorm_SpellName(Language), //153595
                Ebonbolt_SpellName(Language), //257537
                Flurry_SpellName(Language), //44614
                FocusMagic_SpellName(Language), //321358
                FrozenOrb_SpellName(Language), //198149
                GlacialSpike_SpellName(Language), //199786
                IceLance_SpellName(Language), //30455
                IceNova_SpellName(Language), //157997
                IcyVeins_SpellName(Language), //12472
                RayOfFrost_SpellName(Language), //205021
                SummonWaterElemental_SpellName(Language), //31687
        ...
        public override bool CombatTick()
        {
            ...
            if (SpellID1 == 108839 && CanCastCheck(IceFloes_SpellName(Language), "player", false, false))
            {
                if (Debug)
                {
                    Aimsharp.PrintMessage("Casting Ice Floes - " + SpellID1, Color.Purple);
                }
                Aimsharp.Cast(IceFloes_SpellName(Language), true);
                return true;
            }
            #endregion
            ...
            if (Aimsharp.IsCustomCodeOn("FrozenOrb") && Aimsharp.SpellCooldown(FrozenOrb_SpellName(Language)) - Aimsharp.GCD() <= 0 && Aimsharp.CustomFunction("IsRMBDown") == 1)
            {
                return false;
            }
            #endregion
            ...
            //Auto Ice Barrier
            if (CanCastCheck(IceBarrier_SpellName(Language), "player", false, true) && !Aimsharp.HasBuff(IceBarrier_SpellName(Language), "player"))
            {
                if (PlayerHP <= GetSlider("Auto Ice Barrier @ HP%"))
                {
                    Aimsharp.Cast(IceBarrier_SpellName(Language));
                    if (Debug)
                    {
            ...
            if (!NoSpellsteal && CanCastCheck(Spellsteal_SpellName(Language), "mouseover", true, true) && (!GetCheckBox("Don't Spellsteal during Icy Veins:") || GetCheckBox("Don't Spellsteal during Icy Veins:") && !Aimsharp.HasBuff(IcyVeins_SpellName(Language), "player", true)))
            {
            ...
            if (!NoSpellsteal && CanCastCheck(Spellsteal_SpellName(Language), "target", true, true) && (!GetCheckBox("Don't Spellsteal during Icy Veins:") || GetCheckBox("Don't Spellsteal during Icy Veins:") && !Aimsharp.HasBuff(IcyVeins_SpellName(Language), "player", true)))
            {
            ...
            if (Blizzard && CanCastCheck(Blizzard_SpellName(Language), "player", false, true) && !Moving)
            {
                switch (BlizzardCast)
                {
                    case "Manual":
                        ...
                        Aimsharp.Cast(Blizzard_SpellName(Language));
                        return true;
                    case "Player":
                        if (Debug)
                        {
            ...
            if ((Aimsharp.SpellCooldown(FrozenOrb_SpellName(Language)) - Aimsharp.GCD() > 2000 || Moving) && FrozenOrb)
            {
                if (Debug)
                {
            ...
            if (FrozenOrb && CanCastCheck(FrozenOrb_SpellName(Language), "player", false, true) && !Moving)
            {
                switch (FrozenOrbCast)
                {
                    case "Manual":
                        ...
                        Aimsharp.Cast(FrozenOrb_SpellName(Language));
                        return true;
                    case "Player":
                        if (Debug)
                        {
            ...
            if (Aimsharp.TargetIsEnemy() && TargetAlive() && TargetInCombat && Wait <= 200)
            {
                if (!Aimsharp.HasDebuff(Polymorph_SpellName(Language), "target", true) && !Polymorph && !ArcaneExplosion)
                {
                    ...
                    //Target - GCD
                    if (SpellID1 == 319836 && CanCastCheck(FireBlast_SpellName(Language), "target", true, false))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 116 && CanCastCheck(Frostbolt_SpellName(Language), "target", true, true) && !Moving)
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 118 && CanCastCheck(Polymorph_SpellName(Language), "target", true, true) && !Moving)
                    {
                        if (Debug)
                        {
                    ...
                    if (!NoSpellsteal && SpellID1 == 30449 && CanCastCheck(Spellsteal_SpellName(Language), "target", true, true) && (!GetCheckBox("Don't Spellsteal during Icy Veins:") || GetCheckBox("Don't Spellsteal during Icy Veins:") && !Aimsharp.HasBuff(IcyVeins_SpellName(Language), "player", true)))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 321358 && CanCastCheck(FocusMagic_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 31687 && CanCastCheck(SummonWaterElemental_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Summon Water Elemental - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast(SummonWaterElemental_SpellName(Language));
                        return true;
                    }

                    if (SpellID1 == 12472 && CanCastCheck(IcyVeins_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Icy Veins - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast(IcyVeins_SpellName(Language));
                        return true;
                    }
                    ...
                    if (SpellID1 == 235219 && CanCastCheck(ColdSnap_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Cold Snap - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast(ColdSnap_SpellName(Language), true);
                        return true;
                    }

                    if ((SpellID1 == 198149 || SpellID1 == 84714) && CanCastCheck(FrozenOrb_SpellName(Language), "player", false, true) && (Aimsharp.CustomFunction("BlizzardMouseover") == 1 || GetCheckBox("Always Cast Frozen Orb @ Cursor during Rotation") || Aimsharp.IsCustomCodeOn("FrozenOrbCursor")))
                    {
                        if (Debug)
                        {
                    ...
                    else if ((SpellID1 == 198149 || SpellID1 == 84714) && CanCastCheck(FrozenOrb_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 190356 && CanCastCheck(Blizzard_SpellName(Language), "player", false, true) && (Aimsharp.CustomFunction("BlizzardMouseover") == 1 || GetCheckBox("Always Cast Blizzard @ Cursor during Rotation") || Aimsharp.IsCustomCodeOn("BlizzardCursor")))
                    {
                        if (Debug)
                        {
                    ...
                    else if (SpellID1 == 190356 && CanCastCheck(Blizzard_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 11426 && CanCastCheck(IceBarrier_SpellName(Language), "player", false, true) && !Aimsharp.HasBuff(IceBarrier_SpellName(Language), "player", true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 199786 && CanCastCheck(GlacialSpike_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Glacial Spike - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast(GlacialSpike_SpellName(Language));
                        return true;
                    }

                    if (SpellID1 == 153595 && CanCastCheck(CometStorm_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Comet Storm - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast(CometStorm_SpellName(Language));
                        return true;
                    }

                    if (SpellID1 == 157997 && CanCastCheck(IceNova_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 257537 && CanCastCheck(Ebonbolt_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Ebonbolt - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast(Ebonbolt_SpellName(Language));
                        return true;
                    }

                    if (SpellID1 == 321358 && CanCastCheck(FocusMagic_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Focus Magic - " + SpellID1, Color.Purple);
                    ...
                    if (SpellID1 == 30455 && CanCastCheck(IceLance_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Ice Lance - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast(IceLance_SpellName(Language));
                        return true;
                    }

                    if (SpellID1 == 44614 && CanCastCheck(Flurry_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Flurry - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast(Flurry_SpellName(Language));
                        return true;
                    }

                    if ((SpellID1 == 199786 || SpellID1 == 205021) && CanCastCheck(RayOfFrost_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Ray of Frost - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast(RayOfFrost_SpellName(Language));
                        return true;
                    }
                    #endregion
                }
