    ...
    public class EpicEvokerDevastationHekili : Rotation
    {
        ...
        public override bool CombatTick()
        {
            ...
            if (!NoInterrupts && (Aimsharp.UnitID("target") != 168105 || Torghast_InnerFlame.Contains(Aimsharp.CastingID("target"))) && (Aimsharp.UnitID("target") != 157571 || Torghast_InnerFlame.Contains(Aimsharp.CastingID("target"))))
            {
                ...
                if (CanCastCheck(Quell_SpellName(Language), "target", true, true))
                {
            ...
            if (SleepWalk && CanCastCheck(SleepWalk_SpellName(Language), "mouseover", true, true) && !Moving)
            {
                if (Debug)
                {
            ...
            if (Landslide && CanCastCheck(Landslide_SpellName(Language), "player", true, true) && !Moving)
            {
                if (Debug)
                {
            ...
            if (DeepBreath && CanCastCheck(DeepBreath_SpellName(Language), "player", false, true) && !Moving)
            {
            ...
            if (Firestorm && CanCastCheck(Firestorm_SpellName(Language), "player", false, true) && !Moving)
            {
            ...
            if (Aimsharp.TargetIsEnemy() && TargetAlive() && TargetInCombat && Wait <= 200)
            {
                if (!Aimsharp.HasDebuff(SleepWalk_SpellName(Language), "target", true) && !Aimsharp.HasDebuff(Landslide_SpellName(Language), "target", true) && !Landslide)
                {
                    ...
                    ///Class Spells
                    //Target - No GCD
                    if (SpellID1 == 351338 && CanCastCheck(Quell_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    //Target - GCD
                    if (SpellID1 == 356995 && CanCastCheck(Disintegrate_SpellName(Language), "target", true, true) && !Moving)
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 383121 && CanCastCheck(Landslide_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 361469 && CanCastCheck(LivingFlame_SpellName(Language), "target", true, true) && !Moving)
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 358385 && CanCastCheck(Landslide_SpellName(Language), "player", true, true) && !Moving)
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 357210 && CanCastCheck(DeepBreath_SpellName(Language), "player", false, true) && (Aimsharp.CustomFunction("DeepBreathMouseover") == 1 || GetCheckBox("Always Cast Deep Breath @ Cursor during Rotation") || Aimsharp.IsCustomCodeOn("DeepBreathCursor")))
                    {
                        if (Debug)
                        {
                    ...
                    else if (SpellID1 == 357210 && CanCastCheck(DeepBreath_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 368847 && CanCastCheck(Firestorm_SpellName(Language), "player", false, true) && (Aimsharp.CustomFunction("FirestormMouseover") == 1 || GetCheckBox("Always Cast Firestorm @ Cursor during Rotation") || Aimsharp.IsCustomCodeOn("FirestormCursor")))
                    {
                        if (Debug)
                        {
                    ...
                    else if (SpellID1 == 368847 && CanCastCheck(Firestorm_SpellName(Language), "player", false, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 368432 && CanCastCheck(Unravel_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 357211 && CanCastCheck(Pyre_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 370452 && CanCastCheck(ShatteringStar_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 360995 && CanCastCheck(VerdantEmbrace_SpellName(Language), "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 355913 && CanCastCheck(EmeraldBlossom_SpellName(Language), "player", true))
                    {
                        if (Debug)
                        {
        ...
        public override bool OutOfCombatTick()
        {
            ...
            if (SpellID1 == 364342 && CanCastCheck(BlessingOfTheBronze_SpellName(Language), "player", false, true) && BOTBOOC)
            {
                if (Debug)
                {
            ...
            if (CanCastCheck(BlessingOfTheBronze_SpellName(Language), "player", false, true) && !Aimsharp.HasBuff(BlessingOfTheBronze_SpellName(Language), "player", true) && BOTBOOC)
            {
                if (Debug)
                {
                    Aimsharp.PrintMessage("Casting Blessing of the Bronze (Out of Combat) - " + SpellID1, Color.Purple);
